        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Penarikan Tabungan {{$siswa->name}}</h4>
                </div>
                <div class="modal-body">
                    <form action="/addTabungan/{{$siswa->id}}" method="POST">
                        {{csrf_field()}}
                        <input type="hidden" class="form-control" name="siswa_id" value="{{$siswa->id}}">
                        <input type="hidden" class="form-control" name="uang_masuk" value="0">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="number" class="form-control" minlength="5000" name="uang_keluar" value="0">
